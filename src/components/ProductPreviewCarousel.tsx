...
const SOLUTIONS: SolutionSlide[] = [
  ...
  },
  {
    ...
    title: "5 tailor + 2 autofill / month",
    subtitle: "Credit packs from $6 for students",
    activeTab: 0,
    status: "No card required to start — upgrade when you need more",
    highlights: [
      "5 free AI tailor kits every month",
      "2 autofill sessions included",
      "15-kit pack just $6 with .edu email",
    ],
